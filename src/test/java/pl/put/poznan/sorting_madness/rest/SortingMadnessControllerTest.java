...
class SortingMadnessControllerTest {
    ...
    void testSortValues() {
        ...
        //when
        when(sortingMadnessService.sortValues(any(String.class), any(List.class))).thenReturn(List.of(response));
    ...
    void testSortObjects() {
        ...
        //when
        when(sortingMadnessService.sortObjects(any(String.class), any(List.class), any(String.class))).thenReturn(List.of(response));
